...
def main():
    env_name = EnvironmentName("ALE/MsPacman-v4")
    env_kwargs = {}
    n_timesteps = 1e5
    # n_timesteps = 1e4
    normalize = False
    ...
    guide_policy = PPO.load("/home/nj2513/rl-baselines3-zoo/rl-trained-agents/ppo/MsPacmanNoFrameskip-v4_1/best_model").policy
    n = 10
    max_horizon = 650
